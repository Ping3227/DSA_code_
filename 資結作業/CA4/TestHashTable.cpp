...
int main() {
    ...
    doubleTable->show_object();
    // test find 
    Double double1 = Double(10);
    std::cout<<doubleTable->find(&double1)<<std::endl;
    Double double2 = Double(2009);
    std::cout << doubleTable->find(&double2) << std::endl;
